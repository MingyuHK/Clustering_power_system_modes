...
class DecisionTreeClass:
    ...
    def get_features(self):
        ...
        for day in range(0, self.day_num):
            ...
            renew_hour = wind_hour + pv_hour  # 新能源
            load_renew_hour = load_hour - renew_hour  # 负载-新能源
            load_renew_out_hour = load_hour - renew_hour - out_hour  # 负载-新能源-区外
    ...
    def DecisionTree(self, all_samples: list, all_labels: list):
        ...
        # feature_importances.set_xlim(0,10)
        plt.ylim((0, 1))
